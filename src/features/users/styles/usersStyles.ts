...
export const usersStyles = {
  ...
  heading: cn(
    "px-4 text-[24px] font-semibold tracking-tight text-text-primary md:px-6"
  ),
  contentWrap: cn("mt-5 px-4 md:px-6"),
  card: cn(
    "overflow-hidden rounded-[30px] border border-border bg-white shadow-xs"
  ),
  ...
  sheetWrap: cn(
    "fixed inset-y-5 right-5 z-50 flex w-[680px] max-w-[calc(100vw-24px)]"
  ),
  sheet: cn(
  ...
  statusPill: cn(
    "rounded-2xl bg-success-soft px-5 py-2 text-[16px] font-medium text-success-fg"
  ),
  ...
  assignmentsTitle: cn(
    "text-[18px] font-semibold tracking-wide text-text-primary"
  ),
  ...
  assignmentRow: cn(
    "grid grid-cols-[1fr_auto] items-center gap-4 border-b border-border py-5"
  ),
  assignmentTitle: cn("text-[18px] font-medium text-text-primary"),
  assignmentMeta: cn("mt-1 text-[16px] text-panel-muted"),
  footer: cn(
    "mt-auto grid grid-cols-2 gap-5 border-t border-transparent px-8 py-8"
  ),
  secondaryButton: cn(
  ...
  menuContent: cn(
    "w-auto min-w-[214px] rounded-[18px] border border-border bg-white p-2 shadow-[0_20px_50px_rgba(15,23,42,0.12)]"
  ),
  ...
  optionRow: cn(
    "flex items-center gap-4 px-4 py-4 text-[18px] text-text-primary"
  ),
