...
export const assignedLeadStyles = {
  page: cn("mx-auto w-full max-w-6xl"),
  ...
  callAvatar: cn("grid size-12 place-items-center rounded-full bg-white/20 text-sm font-semibold"),
  callMeta: cn("min-w-0"),
  ...
  card: cn("mt-8 overflow-hidden rounded-2xl bg-card ring-1 ring-border"),
  cardHeader: cn(
    "flex flex-wrap items-center justify-between gap-4 border-b border-border px-8 py-7"
  ),
  cardTitle: cn("text-2xl font-semibold tracking-tight text-foreground"),
  cardLink: cn("inline-flex items-center gap-2 text-sm font-semibold text-secondary"),

  contentGrid: cn("grid gap-10 px-8 py-8 lg:grid-cols-[1fr_360px]"),
  ...
  purchaseCard: cn("mt-12 overflow-hidden rounded-2xl bg-muted/30 ring-1 ring-border"),
  purchaseHeader: cn("flex items-center justify-between gap-4 border-b border-border px-6 py-5"),
  ...
  timelineWrap: cn("mt-6"),
  timelineList: cn("relative pl-8"),
  timelineLine: cn("absolute bottom-0 left-3.5 top-0 w-px bg-border"),
  timelineItems: cn("flex flex-col gap-8"),
  timelineDotWrap: cn(
    "absolute left-[-34px] top-0.5 grid size-8 place-items-center rounded-full bg-status-active-bg text-status-active-fg ring-4 ring-white"
  ),
  timelineDot: cn("size-2.5 rounded-full bg-secondary"),
  timelineItemTitle: cn("text-sm font-semibold text-foreground"),
  timelineItemSubtitle: cn("mt-1 text-sm text-muted-foreground"),

  emptyWrap: cn("flex flex-1 flex-col items-center justify-center py-20 text-center"),
