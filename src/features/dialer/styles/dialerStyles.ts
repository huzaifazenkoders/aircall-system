...
export const dialerShellStyles = {
  ...
  nav: cn("flex flex-1 items-center gap-2 overflow-x-auto lg:flex-col lg:gap-6 lg:overflow-visible"),
  navItem: cn(
  ...
  topbar: cn("flex items-center justify-end border-b border-border px-2 pb-4 lg:pb-5"),
  avatar: cn("grid size-11 place-items-center overflow-hidden rounded-xl border border-border bg-white shadow-xs"),
  ...
  titleRow: cn("flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"),
  title: cn("text-[2rem] font-semibold tracking-tight text-text-primary lg:text-[2.625rem]"),
};
...
export const callHistoryStyles = {
  ...
  statItem: cn("flex min-h-36 flex-col justify-center gap-2 px-8 py-6 xl:border-r xl:border-border last:border-r-0"),
  statLabel: cn("text-[1rem] text-[#6B7A99] lg:text-[1.125rem]"),
  statValue: cn("text-[3.25rem] font-medium leading-none tracking-tight text-[#127A79]"),
  tableCard: cn(
  ...
  emptyTitle: cn("mt-8 text-[2rem] font-medium tracking-tight text-text-primary lg:text-[3rem]"),
  emptyDescription: cn("mt-4 max-w-2xl text-xl leading-[1.45] text-[#667794] lg:text-[1.75rem]"),
  sheetHeader: cn("px-8 pt-8 pb-6"),
  sheetTitle: cn("text-[2.125rem] font-semibold tracking-tight text-text-primary"),
  sheetSection: cn("border-t border-border px-8 py-8"),
  sheetSectionTitle: cn("text-[1.125rem] font-semibold tracking-wide text-text-primary"),
  ...
  link: cn("mt-1.5 inline-flex items-center gap-2 text-[1.125rem] text-[#166A6D] underline underline-offset-4"),
  representative: cn("mt-1.5 flex items-center gap-3 text-[1.125rem] text-text-primary lg:text-[1.25rem]"),
  representativeAvatar: cn("grid size-9 place-items-center overflow-hidden rounded-full bg-[#F8D7C7] text-sm font-semibold text-[#7A2F2F]"),
  ...
  recordingIconWrap: cn("grid size-12 place-items-center rounded-full border border-[#A8DFE3] bg-white/55 text-[#0B5E61]"),
  recordingLabel: cn("text-[1rem] font-medium text-text-primary"),
  recordingTime: cn("mt-0.5 text-[1rem] text-[#62708A]"),
  playButton: cn("grid size-12 place-items-center rounded-full bg-white text-[#364152] shadow-xs"),
};
...
export const callbackStyles = {
  ...
  dialogBody: cn("grid min-h-0 flex-1 gap-0 lg:grid-cols-[minmax(0,1.55fr)_minmax(18rem,0.95fr)]"),
  dialogLeft: cn("min-w-0 px-6 py-6 lg:px-8"),
  dialogRight: cn("border-t border-border px-6 py-6 lg:border-t-0 lg:border-l lg:px-8"),
  sectionTitle: cn("text-[1.125rem] font-semibold tracking-wide text-text-primary"),
  ...
  pill: cn("inline-flex h-8 items-center rounded-[0.75rem] bg-status-cooldown-bg px-4 text-base font-medium text-status-cooldown-fg"),
  purchaseCard: cn("mt-8 overflow-hidden rounded-[1.75rem] border border-border bg-white"),
  purchaseHeader: cn("flex flex-col gap-4 border-b border-border px-5 py-5 sm:flex-row sm:items-center sm:justify-between"),
  purchaseTitle: cn("text-[1.125rem] font-medium text-text-primary lg:text-[1.25rem]"),
  purchaseTotalWrap: cn("flex items-center gap-3"),
  purchaseTotalLabel: cn("text-[1rem] font-semibold uppercase tracking-wide text-[#6B7A99]"),
  purchaseTotalValue: cn("text-[1.625rem] font-semibold text-[#127A79]"),
  purchaseTableWrap: cn("max-h-[34rem] overflow-auto"),
  purchaseHead: cn("px-4 py-4 text-left text-[1rem] font-medium text-[#6B7A99] lg:px-5"),
  purchaseCell: cn("px-4 py-4 text-[1.125rem] text-text-primary lg:px-5"),
  tabs: cn("flex flex-wrap gap-6"),
  tab: cn("border-b-[3px] border-transparent pb-3 text-[1rem] text-[#6B7A99] transition-colors"),
  ...
  timelineDot: cn("grid size-10 place-items-center rounded-full bg-[#C9FAF3] text-primary"),
  ...
  noteItem: cn("rounded-2xl bg-[#F7FAFC] px-4 py-4 text-[1rem] leading-7 text-text-primary"),
  emptyWrap: cn("flex min-h-[42rem] flex-1 items-center justify-center px-6"),
  emptyInner: cn("flex max-w-2xl flex-col items-center text-center"),
  emptyTitle: cn("mt-8 text-[2rem] font-medium tracking-tight text-text-primary lg:text-[3rem]"),
  emptyDescription: cn("mt-4 max-w-2xl text-xl leading-[1.45] text-[#667794] lg:text-[1.75rem]"),
