const DialerTopbar = () => {
  return (
    <header className="flex items-center justify-end border-b border-border px-2 pb-4 lg:pb-5">
      <div className="flex items-center gap-3">
        <div className="grid size-11 place-items-center overflow-hidden rounded-xl border border-border bg-white shadow-xs">
          <svg
            viewBox="0 0 48 48"
            className="size-full"
            fill="none"
        ...
        <div className="leading-tight">
          <div className="text-sm text-[#94A3B8]">Hello</div>
          <div className="text-sm font-semibold text-text-primary">James Smith</div>
        </div>
      </div>
    </header>
  );
